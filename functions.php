        ...
        <div id="woo-chatbot-ball-wrapper" style="display:none">
            ...
            <div id="woo-chatbot-ball-container" style="display:none" class="woo-chatbot-ball-container">
                ...
                <div id="woo-chatbot-editor-container" class="woo-chatbot-editor-container">
                    <input id="woo-chatbot-editor" class="woo-chatbot-editor" required placeholder="<?php esc_html_e('Send a message.', 'woowbot-woocommerce-chatbot'); ?>">
                    <button type="button" id="woo-chatbot-send-message" class="woo-chatbot-button"><?php esc_html_e('send', 'woowbot-woocommerce-chatbot'); ?></button>
                </div>
            </div>
